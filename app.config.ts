...
const env = {
  ...
  appName: "NeuroLaserMap", // Trigger new build
...
const config: ExpoConfig = {
  ...
  web: {
    ...
    baseUrl: "/NeuroLaserMap/",
    router: {
      origin: "https://charonefono-prog.github.io/NeuroLaserMap/",
      unstable_hash: true
    },
    pwa: {
      enabled: true,
      ...
      themeColor: "#667eea",
      name: "NeuroLaserMap",
      shortName: "NeuroLaser",
      description: "Mapeamento de Neuromodulação com Laser",
      icons: [
        {
